    ...
    <div className='page-size'>
      ...
      <div className='container-fluid'>
        <div className='container quote'>
          <p className='quote-text'>Guiding Young Minds with Purpose and Pride From the classroom to the community, AUGIC Genwla fosters excellence and ethical leadership.
          </p>
        </div>
      </div>
